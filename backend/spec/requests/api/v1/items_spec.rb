...
RSpec.describe "Api::V1::Items", type: :request do
  ...
  describe "POST /api/v1/lists/:list_id/items" do
    ...
    context "with valid parameters" do
      it "creates a new Item" do
        expect {
          post "/api/v1/lists/#{list.id}/items", params: valid_attributes, as: :json
      ...
      it "allows nil rating" do
        post "/api/v1/lists/#{list.id}/items", params: { item: { name: 'Unrated Item', rating: nil } }, as: :json
        expect(response).to have_http_status(:created)
        json_response = JSON.parse(response.body)
    ...
    context "with invalid parameters" do
      it "does not create a new Item" do
        expect {
          post "/api/v1/lists/#{list.id}/items", params: invalid_attributes, as: :json
  ...
  describe "PATCH /api/v1/items/:id" do
    ...
    context "with valid parameters" do
      before { patch "/api/v1/items/#{item.id}", params: new_attributes, as: :json }
    ...
    context "with invalid parameters" do
      ...
      before { patch "/api/v1/items/#{item.id}", params: invalid_attributes, as: :json }
